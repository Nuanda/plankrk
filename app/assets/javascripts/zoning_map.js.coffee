...
#    }).addTo map
    ...
    L.esri.basemapLayer('Streets').addTo(@zoningMap)
    ...
    window.districtContours.addTo @zoningMap


  $('#zoning-switch').on 'click', ->
    if @zoningMap.hasLayer window.districtContours
      @zoningMap.removeLayer window.districtContours
    else
      @zoningMap.addLayer window.districtContours

    if @zoningMap.hasLayer window.detailedZoning
      @zoningMap.removeLayer window.detailedZoning
    else
      @zoningMap.addLayer window.detailedZoning
